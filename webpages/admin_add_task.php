...
if(isset($_POST['create_task'])) {
    ...
    $query = "INSERT INTO task(task_title, task_type, task_desc, task_subject, page_count, word_count, file_format, sample, claim_deadline, submission_deadline, task_tags, task_statues) ";
    
    $query .= "VALUES('{$task_title}','{$task_type}','{$task_desc}','{$task_subject}','{$page_count}','{$word_count}','{$file_format}','{$sample}','{$claim_deadline}','{$submission_deadline}','{$drop_down_one}','{$task_status}' ) ";
